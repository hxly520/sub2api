...
> 私有维护分支开始开发或合并官方版本前，必须先阅读 [私有二开维护与官方升级指南](docs/PRIVATE_CUSTOMIZATION_CN.md)。图片和视频接口以 [媒体 API 契约](docs/MEDIA_API_CN.md) 为准，不能从单个供应商示例反推公共协议。
...
| **release.yml** | tag `v*-52t.*` | 构建私有发布（PR 不触发） |
