...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			linkcardgroupauthorization.Table:    linkcardgroupauthorization.ValidColumn,
			linkcardledger.Table:                linkcardledger.ValidColumn,
			linkcardoperation.Table:             linkcardoperation.ValidColumn,
