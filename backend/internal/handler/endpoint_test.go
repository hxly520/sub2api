...
func TestNormalizeInboundEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"/v1/video/generations", EndpointVideoGenerations},
		{"/v1/video/generations/task_123", EndpointVideoGenerations},
		{"/videos", EndpointVideos},
		{"/v1/videos/req_123", EndpointVideos},
		{"/contents/generations/tasks", EndpointContentTasks},
		{"/contents/generations/tasks/task_123", EndpointContentTasks},
