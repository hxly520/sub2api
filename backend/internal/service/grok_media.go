...
type GrokVideoPendingBilling struct {
	...
	MediaPricingSnapshot *MediaGenerationPricingSnapshot `json:"media_pricing_snapshot,omitempty"`
	MediaBalanceHold     *MediaBalanceHoldCommand        `json:"media_balance_hold,omitempty"`
}
