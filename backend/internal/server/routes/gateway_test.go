...
func TestGatewayRoutesOpenAIVideosPathsAreRegistered(t *testing.T) {
	...
	for _, path := range []string{
		...
		req := httptest.NewRequest(http.MethodPost, path, strings.NewReader(`{"model":"sora-2","prompt":"waves"}`))
		req.Header.Set("Content-Type", "application/json")
		w := httptest.NewRecorder()
	...
	for _, path := range []string{
		...
		"/v1/video/generations/request-123",
		"/video/generations/request-123",
		"/v1/video/generations/request-123/content",
		"/video/generations/request-123/content",
		"/v1/contents/generations/tasks/request-123",
		"/contents/generations/tasks/request-123",
		"/v1/contents/generations/tasks/request-123/content",
		"/contents/generations/tasks/request-123/content",
	} {
...
func TestGatewayRoutesOpenAIVideosRejectedForAnthropic(t *testing.T) {
