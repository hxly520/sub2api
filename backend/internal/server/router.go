...
func SetupRouter(
	...
	if web.HasEmbeddedFrontend() {
		frontendServer, err := web.NewFrontendServer(settingService) //nolint:staticcheck // The !embed stub is intentionally an always-error fallback; the embed build can succeed.
		if err != nil {                                              //nolint:staticcheck // The !embed stub is intentionally an always-error fallback; the embed build can succeed.
