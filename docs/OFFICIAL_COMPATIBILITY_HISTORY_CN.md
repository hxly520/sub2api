...
| `v0.2.1` | `ab99d56e9626e6cd731592dae8553c9758a0efa2` | `v0.2.1-52t.2` released candidate; production switch pending | 从当前生产基线 `v0.1.183-52t.4` 升级。官方网关、协议、重试、计费、缓存和调度优先；保留积分、提链/额度卡、媒体冻结/核销、视频、TTFT、Codex 48 KiB 响应头保护、首页和帮助页。官方 `231-234` 与私有迁移按完整文件名/checksum 共存。源码、测试、CI、Release、镜像、digest 和 OCI revision 已完成；仅允许维护者手工 Compose 切换，生产切换与生产冒烟仍待维护者执行。 |
