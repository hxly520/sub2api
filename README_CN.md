...
本仓库当前升级候选基于官方 Sub2API `v0.2.1`（源码 commit `ab99d56e9626e6cd731592dae8553c9758a0efa2`），候选版本标识为 `v0.2.1-52t.3`。生产环境基线仍为 `v0.1.183-52t.4`，本地合并、测试和 GitHub Actions 构建都不会自动替换或重启生产容器；生产切换由维护者在备份与回滚点确认后手工执行。
