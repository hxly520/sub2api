...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/hxly520/sub2api:0.1.172-52t.1
...
SUB2API_IMAGE=ghcr.io/hxly520/sub2api:0.1.172-52t.1 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
