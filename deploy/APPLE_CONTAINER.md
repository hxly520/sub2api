...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/hxly520/sub2api:0.1.183-52t.1 # pin the approved immutable release
...
SUB2API_IMAGE=ghcr.io/hxly520/sub2api:0.1.183-52t.1 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
