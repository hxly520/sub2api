export default {
    settings: {
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'API Service Management Console',
        ...
        qqGroupUrl: 'Join QQ Group URL',
        qqGroupUrlHint: 'Shown to the left of Docs in the top bar. Leave empty to hide it. Only http:// and https:// URLs are allowed.',
        qqGroupUrlPlaceholder: 'https://qm.qq.com/...',
        qqGroupUrlInvalid: 'The QQ group URL must be a valid http:// or https:// address.',
        siteLogo: 'Site Logo',
        ...
        homeContentPlaceholder: 'Enter plain text or restricted HTML, or provide an HTTPS URL for restricted iframe mode.',
        homeContentHint: 'Only static headings, paragraphs, lists, quotations, code, and links are retained. Scripts, forms, inputs, images, inline styles, and event handlers are removed.',
        homeContentIframeWarning: 'Security restriction: remote home pages require HTTPS. The iframe uses an empty sandbox and no-referrer policy, so scripts, forms, downloads, and top-level navigation are not authorized.',
      ...
      payment: {
        ...
        field_keyingpayApiBaseHint: 'The KeyingPay V2 default is https://api.keyingpay.org. Change it only when the provider supplies another V2 API base.',
        field_paymentCurrencyHint: 'Default is CNY. Stripe and Airwallex can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, EasyPay, and KeyingPay remain CNY.',
