export default {
  ...
  version: {
    ...
    sourceModeHint: 'Source build; pull the configured private repository and rebuild to update',
    repository: 'Repository',
    channel: 'Channel',
    policy: 'Policy',
    policyHotSafe: 'Binary hot update allowed',
    policyImageRecommended: 'Compose update recommended',
    policyImageRequired: 'Compose update required',
    image: 'Image',
    composeUpdateRequired: 'Compose update required',
    composeUpdateHint: 'This release contains changes that cannot be replaced in place. Update the configured private image with Docker Compose.',
    composeReasons: 'Policy details',
    composePinImage: 'Pin the private image version',
    rollbackComposeOnly: 'This version can only be restored by pinning its private image with Docker Compose.',
