export default {
  ...
  pointsSettings: {
    title: 'Points System',
    subtitle: 'Runtime status and policy controls',
    ...
    notConfigured: 'The points bridge is not configured. User access remains disabled.',
    bridgeTitle: 'Bridge configuration',
    bridgeStatus: 'Bridge status',
    userEntry: 'User access',
    policyConsole: 'Policy settings',
    publicUrl: 'Points service URL',
    menuLabel: 'Menu label',
    launchKey: 'Launch signing key',
    creditKey: 'Balance signing key',
    ticketTtl: 'Launch ticket TTL',
    clockSkew: 'Signature clock skew',
    ready: 'Ready',
