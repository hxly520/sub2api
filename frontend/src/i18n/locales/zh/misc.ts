export default {
  ...
  version: {
    ...
    refresh: '刷新',
    sourceMode: '源码构建',
    sourceModeHint: '源码构建请从配置的私有仓库 git pull 后重新构建',
    repository: '更新仓库',
    channel: '更新通道',
    policy: '更新策略',
    policyHotSafe: '允许二进制热更新',
    policyImageRecommended: '建议使用 Compose 更新',
    policyImageRequired: '必须使用 Compose 更新',
    image: '容器镜像',
    composeUpdateRequired: '需要使用 Compose 更新',
    composeUpdateHint: '此版本包含不能原地替换的变更，请更新配置的私有镜像并使用 Docker Compose 重建。',
    composeReasons: '策略说明',
    composePinImage: '锁定私有镜像版本',
    rollbackComposeOnly: '此版本只能通过 Docker Compose 锁定对应私有镜像进行回退。',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
