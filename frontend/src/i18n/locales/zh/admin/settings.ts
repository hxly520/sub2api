export default {
    settings: {
      ...
      security: {
        ...
        auditRetentionHint: '超过该天数的操作日志将被自动清理；默认保留 30 天，填 0 表示永久保留（仅支持手动清空）。'
      },
      panelRateLimit: {
        title: '面板接口限流',
      ...
      site: {
        ...
        qqGroupUrl: '加入 Q 群链接',
        qqGroupUrlHint: '显示在右上角“文档”左侧。留空则隐藏入口，仅支持 http:// 或 https:// 链接。',
        qqGroupUrlPlaceholder: 'https://qm.qq.com/...',
        qqGroupUrlInvalid: '加入 Q 群链接必须是有效的 http:// 或 https:// 地址。',
        siteLogo: '站点Logo',
        uploadImage: '上传图片',
        remove: '移除',
        logoHint: 'PNG、JPG、WebP 或 GIF 格式，最大 300KB。建议：80x80px 正方形图片。',
      ...
      payment: {
        ...
        field_keyingpayApiBaseHint: '可盈Pay V2 默认地址为 https://api.keyingpay.org；仅在服务商明确提供其它 V2 API 地址时修改。',
        field_paymentCurrencyHint: '默认 CNY。Stripe 和 Airwallex 可按账户支持从下拉项选择 HKD、USD 等币种；微信、支付宝、易支付和可盈Pay仍按 CNY。',
