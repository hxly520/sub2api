  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        qqGroupUrl: 'QQ group URL',
        qqGroupUrlPlaceholder: 'https://qm.qq.com/q/xxxxxx',
        qqGroupUrlHint: 'Opened from the top bar. Supports https/http or mqqapi links; leave empty to hide the entry.',
        siteLogo: 'Site Logo',
