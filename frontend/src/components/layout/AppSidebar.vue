...
// The points policy can change independently at the next natural-day boundary.
...
const pointsMenuLabel = computed(() =>
  appStore.cachedPublicSettings?.points_system_menu_label?.trim() || t('nav.pointsCenter')
)
