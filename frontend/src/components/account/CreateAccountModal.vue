    ...
    >
      ...
      >
        <div class="flex items-center justify-between gap-4">
          ...
          <button
            type="button"
            data-testid="create-openai-upstream-relay-toggle"
...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (accountCategory.value === 'apikey' && openaiUpstreamRelayEnabled.value) {
    extra.openai_upstream_relay = true
  } else {
    delete extra.openai_upstream_relay
  }
